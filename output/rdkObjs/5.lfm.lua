...
local function constructNew_frmLojaDePocoes()
...
function newfrmLojaDePocoes()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmLojaDePocoes();
      end,
      function()
...
local _frmLojaDePocoes = {
    newEditor = newfrmLojaDePocoes, 
    new = newfrmLojaDePocoes, 
    name = "frmLojaDePocoes", 
    dataType = "", 
    formType = "undefined", 
...
frmLojaDePocoes = _frmLojaDePocoes;
Firecast.registrarForm(_frmLojaDePocoes);

return _frmLojaDePocoes;
